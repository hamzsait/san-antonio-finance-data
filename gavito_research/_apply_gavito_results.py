...
Usage:
    python _apply_gavito_results.py            # apply
    python _apply_gavito_results.py --dry-run  # report only, no writes
"""
import glob
import json
import os
...
cat_counts = {}
files = sorted(glob.glob(os.path.join(ROOT, "gavitobatch_*_results.json")))
