...
Usage:
    python _apply_mungia_results.py            # apply
    python _apply_mungia_results.py --dry-run  # report only, no writes
"""
import glob
import json
import os
...
cat_counts = {}
files = sorted(glob.glob(os.path.join(ROOT, "mungiabatch_*_results.json")))
