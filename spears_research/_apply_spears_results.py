...
Usage:
    python _apply_spears_results.py            # apply
    python _apply_spears_results.py --dry-run  # report only, no writes
"""
import glob
import json
import os
...
cat_counts = {}
files = sorted(glob.glob(os.path.join(ROOT, "spearsbatch_*_results.json")))
